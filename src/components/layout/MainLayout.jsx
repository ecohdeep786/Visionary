...
function MainLayout({ children, currentPageName }) {
  ...
  useEffect(() => {
    document.title = currentPageName ? `${currentPageName} - Visionary` : "Visionary - AI-Powered Education Platform";
    ...
    metaDescription.content = 'Visionary - AI-Powered Education Platform for Students, Teachers, and Professionals';
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <header className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${!isScrolled ? 'bg-white' : ''}`}>
                  ...
                  <div className="hidden xl:flex items-center gap-6">
                    ...
                    <div className="relative group">
                      ...
                      <div className="absolute top-full left-0 w-56 bg-white rounded-lg shadow-lg border border-gray-100 py-2 mt-1 hidden group-hover:block z-50">
                        ...
                        <Link to={createPageUrl("Parents")} className="block px-4 py-2 text-[15px] text-gray-700 hover:bg-gray-50 transition-colors">
                          Parents
                        </Link>
                      </div>
                    </div>
                    ...
                    <button className="flex items-center gap-2 text-sm font-medium text-gray-700 hover:text-blue-600 transition-colors" style={{ fontFamily: '"Product Sans", "Google Sans", sans-serif' }}>
                      <User size={16} />
                    </button>
                    </div>
                    </div>
        ...
        {isScrolled && (
          <div className="hidden lg:flex justify-center pt-4 pb-4">
            <div className="bg-white rounded-full shadow-lg px-8 py-4 flex items-center gap-6">
              ...
              <Link to={createPageUrl("Parents")} className="text-[15px] font-medium text-[#5f6368] hover:text-gray-900 hover:bg-gray-100 px-4 py-2 rounded-[90%] transition-all" style={{ fontFamily: '"Product Sans", "Google Sans", Roboto, Arial, sans-serif' }}>
                Parents
              </Link>

              <Link to={createPageUrl("Download")}>
                <button className="bg-black hover:bg-gray-800 text-white text-[15px] font-medium px-6 py-3 rounded-full transition-all flex items-center gap-2" style={{ fontFamily: '"Product Sans", "Google Sans", Roboto, Arial, sans-serif' }}>
      ...
      {/* Mobile Menu Overlay */}
      {mobileMenuOpen && (
        <div className="fixed inset-0 bg-black/50 z-[100] xl:hidden" onClick={() => setMobileMenuOpen(false)}>
          <div className="fixed top-0 left-0 w-64 h-full bg-white shadow-xl z-[101]" onClick={(e) => e.stopPropagation()}>
            <div className="p-6">
              ...
              <div className="space-y-4">
                <a href="#" className="block text-[15px] font-medium text-[#5f6368] hover:text-gray-900 py-2" style={{ fontFamily: '"Product Sans", "Google Sans", Roboto, Arial, sans-serif' }}>
                  Where to start?
                </a>
                <a href="#" className="block text-[15px] font-medium text-[#5f6368] hover:text-gray-900 py-2" style={{ fontFamily: '"Product Sans", "Google Sans", Roboto, Arial, sans-serif' }}>
                  Solutions
                ...
                <a href="#" className="block text-[15px] font-medium text-[#5f6368] hover:text-gray-900 py-2" style={{ fontFamily: '"Google Sans", Roboto, Arial, sans-serif' }}>
                  Get support
                </a>
                ...
                <div className="border-t border-gray-200 pt-4 mt-4">
                  ...
                  <Link to={createPageUrl("Parents")} className="block text-[15px] font-medium text-[#5f6368] hover:text-gray-900 py-2" style={{ fontFamily: '"Google Sans", Roboto, Arial, sans-serif' }}>
                    Parents
                  </Link>
                  <a href="#" className="block text-[15px] font-medium text-[#5f6368] hover:text-gray-900 py-2" style={{ fontFamily: '"Google Sans", Roboto, Arial, sans-serif' }}>
                    Expert support
                ...
                <div className="border-t border-gray-200 pt-4 mt-2 space-y-3">
                  <Link to={createPageUrl("Download")} className="block">
                    <button className="w-full bg-blue-600 hover:bg-blue-700 text-white text-[15px] font-medium px-6 py-2.5 rounded-full transition-all flex items-center justify-center gap-2" style={{ fontFamily: '"Google Sans", Roboto, Arial, sans-serif' }}>
                      <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M5 20h14v-2H5v2zM19 9h-4V3H9v6H5l7 7 7-7z" fill="currentColor"/>
                      </svg>
                      Download Now
      ...
      {/* Main Content */}
      <main className={!isScrolled ? "pt-20" : "pt-20"}>
        {children}
      </main>
      ...
      <footer className="bg-white border-t border-gray-200 mt-32">
        <div className="w-full px-6 md:px-12 py-16">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-12 mb-16">
            ...
            <div>
              <h4 className="text-sm font-semibold text-gray-900 mb-4">Enterprise</h4>
              <ul className="space-y-3">
                <li><a href="#" className="text-sm text-gray-600 hover:text-gray-900">For Schools</a></li>
                <li><a href="#" className="text-sm text-gray-600 hover:text-gray-900">For Institutions</a></li>
                <li><a href="#" className="text-sm text-gray-600 hover:text-gray-900">Enterprise Plans</a></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li><a href="#" className="text-sm text-gray-600 hover:text-gray-900">About Visionary</a></li>
